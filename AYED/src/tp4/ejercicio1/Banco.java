...
public class Banco {
	 ...
	 * 
	 * 2º
	 *  aux = [0, 3, 0, 0, 0, -3,  0, 0] --> esto indica que de la posición 1 hasta el final 
	 *                                       tengo que poner un +3, el -3 en la posición 5 me lo anula 
	 *                                       cerrando el rango de actualización.
	 *  aux = [0, 3, 0, 2, 0, -3, -2, 0] --> de la posicion 3 al +3 que venia arrastrando se agrega un +2,
	 *                                       en la posición 5 el +3 se anula pero sigue estando el +2 
	 *                                       hasta que la posicion 7.   
	 *  
	 * 3º
	 *  aux = [0, 3, 3, 5, 5, 2, 0, 0] --> Luego de procesar aux, estos son los valores que tengo que 
	 *                                     sumar a las cuentas
	 */
